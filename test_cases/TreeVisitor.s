...
TreeVisitor$main$preludeEnd:
        ...
        nop
        MOV %o0, %l5
        BA TreeVisitor$main$epilogBegin
        nop
TreeVisitor$main$epilogBegin:
        clr %o0
        call exit
        nop
TV$Start:
...
TV$Start$preludeEnd:
        ...
        SET 0,%g1
        MOV %g1,%i0
        BA TV$Start$epilogBegin
        nop
TV$Start$epilogBegin:
        ret
        restore
Tree$Init:
        .set LOCLS,0
...
Tree$accept$preludeEnd:
        ...
        SET 0,%l6
        MOV %l6,%i0
        BA Tree$accept$epilogBegin
        nop
Tree$accept$epilogBegin:
        ret
        restore
Visitor$visit:
        .set LOCLS,1
...
if$end091:
        SET 0,%g1
        MOV %g1,%i0
        BA MyVisitor$visit$epilogBegin
        nop
if$then086:
        ADD %i0,0,%g1
        MOV %g1,%g1
