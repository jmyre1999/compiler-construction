...
public final class SymbolTableGen implements SyntaxTreeVisitor <Void>  {
   ...
   public Void visit (MainClass n) {
      ...
      MiniJavaMethod new_method = new MiniJavaMethod("main", "void", currentClass);
      currentClass.methodTable.put("main", new_method);
      new_method.paramList.add(n.i2.s);
   ...
   public Void visit (final MethodDecl n) {
      ...
      MiniJavaMethod new_method = new MiniJavaMethod(id_string, type_string, currentClass);
   ...
   public Void visit (FormalDecl n) {
      ...
      currentMethod.paramList.add(id_string);
